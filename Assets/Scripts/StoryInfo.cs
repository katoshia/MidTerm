...
//            Trophy(optionCount);
//        }
//        else if (theName == "Explore TrophyButton Room")
//        {
...
//        public static void BackWoodsButton(int optionCount) { }
//        // crypt - 4 - Go Inside Crypt, Forest, Gardens, Estate
//        public static void CryptButton(int optionCount) { }
...
//        public static void SearchCoffinsButton(int optionCount) { }
//        // gardens - 3 - lake, crypt, estate
//        public static void GardensButton(int optionCount) { }
//        // main Entry Hall - Upstairs/Main Hall, Library, Explore Main Entry
//        public static void MainEntryHallButton(int optionCount) { }
//        // Explore main entry - 2 - Upstairs/Main Hall, Library
//        public static void ExploreMainEntryButton(int optioinCount) { }
