...
public class StoryScript : MonoBehaviour
{
    ...
    void PrintMainEntry()
    {
        console.WriteLine("You enter the main entry hall. Pillars, suits of armor
        and benches line the walls of this room.There is also a large
        chandelier that hangs from the ceiling and a decorative red and gold
        rug that covers most of the polished stone floor.There are stairs
        that lead up to a hallway and a door that goes to the library.");
    }
    ...
    {
        console.WriteLine("You explore the room, moving around the pillars and the suits of
        armor.There does not seem to be anything special about this room,
        though, you do find on one wall there is a round mirror with a thin
    silver frame that is between two of the pillars with two suits of
    armor seeming to stand guard.");
    }
    ...
    void PrintHallway()
    {
        console.WriteLine("You enter the quiet hallway, your footsteps echoing. The walls are
        decorated with paintings, suits of armor and potted plants as you walk
        along.There are doors to a sitting room, a door to the trophy room
        and a door to the bathroom.There are also stairs leading up to the
        second level.");
    }
    ...
    {
        console.WriteLine("You enter a room featuring a large soft bear rug in the center of the
        floor.Between cases of weapons and other trinkets, are a set of
        comfortable chairs.On the walls near the doors are mounted animal
        heads, such as a bear and moose.There is a door to the hallway and a
        door to the library in this room.");
    }
    ...
    {
        console.WriteLine("There are many things to look at in this room. There are a variety of
        swords in the weapon cases.There is a shelf that hold skulls of
        creatures you can't identify. You find that the rug on the floor is
    ...
    void PrintLibrary()
    {
        console.WriteLine("Entering the library, you see many bookshelves lining the walls that
        are full of books.You also see a table and chairs for reading, a desk
       and a lecturn with a book on it.There is a door to the trophy room
       and doors to the main entry hall here.");
    }
    ...
    {
        console.WriteLine("The room is kept very neat. There is a stack of blank writing paper on
        the desk with a pen sitting in an ink jar.There are a half dozen
        unused candles in one of the desk drawers.Most noteably, in this
        room, is the collection of books on the bookshelves.There are many
        titles of literature and stories that you recognize, but there are
        also many more titles that you don't. The titles speak of places
        you've never heard of, strange beasts, ghosts and magic.");
    }
    ...
    {
        console.WriteLine("You begin to pull a thick book off of the shelf, but it stops as
        you hear a click.You are fast enough on your feet to get out of the
        way as the bookshelf swings slowly outward, revealing another room
        hidden behind it.");
    }
    ...
    void PrintBathroom()
    {
        console.WriteLine("You step into this small room and find little of interest. There is a
        sink with a mirror and a toilet.");
    }
    ...
    {
        console.WriteLine("You step past the bookshelf that turned into a door and enter a dusty
        smelling room.Holding up your lantern, you see three chests and a full
        length mirror that is decorated with silver moons and gold suns around its edge.");
    }
    ...
    {
        console.WriteLine("You explore the room and see that the mirror is as tall and wide as a
        door as it sits against the wall.You then turn your attention to the
        chests, which you find are not locked and easy to open.You open the
        first chest and find inside a set of deep purple colored robes made of
        a fine fabric.There is also a box of six wands carved from different
       materials, including one that looks to be made from crystal.The
       second chest is full of thick dusty tomes.The tomes are full of
        symbols and strange writing.In the last chest, you find several
        trinkets such as a long carved staff and a crystal ball.");
    }
    ...
    {
        console.WriteLine("You enter the sitting room which features several comfortable places
        to sit, a few potted plants to bring life to the room and paintings
        decorating the walls.There is a door to the hallway and a door to the
        dining room");
    }
    ...
    {
        console.WriteLine("You enter the largest room so far, the dining room. A big table
        surrounded by ten chairs is at the center.At one end is a smaller,
        round table.Paintings and plotted plants decorate this room as well as display cases with precious china.There is a door to the sitting
        room, a door to the kitchen and a door to the pantry.");
    }
    ...
    void PrintKitchen()
    {
        console.WriteLine("Entering the kitchen, you smell all kinds of good things. There is a
        large fireplace with a cooking pot hanging over flames and embers.
        There are several tables and counters where food is being prepped.");
    }
    ...
    void PrintPantry()
    {
        console.WriteLine("You open the door and enter the pantry. Inside you see several bottles
        of wine, sacks of flour and crates of potatoes.There is a door to the
        dining room here.");
    }
    ...
    {
        console.WriteLine("You find yourself in another hallway, though this one smaller than the
        one at the front door.There is a door to the kitchen and stairs
        leading up to the Servant's Hall.");
    }
    ...
    {
        console.WriteLine("You enter a hallway on the second floor of the manor. Along the walls
        are more art displays.There are stairs that lead down to the first
        floor and a door that leads to the master bedroom.There are archways
        that lead to two other hallways.");
    }
    ...
    {
        console.WriteLine("You enter another hallway from the main hall of the second floor. Here
        you see a door to the guest room, an open arch way to the main hall
        and another arch way into another hall.");
    }
    ...
    {
        console.WriteLine("You walk down a new hallway lined with several paintings of
        landscapes.You see a few potted plants in this hall as well.There is
        a set of stairs leading up to the third floor attic room and an arch
        way going to the previous hall.");
    }
    ...
    {
        console.WriteLine("You move slowly along the hall, examining the paintings. There is one
        of a mountain landscape, one of a beach with a setting sun, one of
        horses running across rolling fields and a number of others.While
        doing so, you realize that the painting of the horses has something
        behind it.When you move the painting, you see a button behind the
    ...
    {
        console.WriteLine("The button presses in easily when you push it. There is a click just
        before a stone door opens.");
    }
    ...
    void PrintRoyalRoom()
    {
        console.WriteLine("When you enter this room, it looks like another closet. The difference
        is, though, that the clothes here are much fancier.Not only are there
        clothes, but there are crowns and circlets, septors and staves.On one
        wall is a full length mirror.");
    }
    ...
    {
        console.WriteLine("This is a mostly plain hall with a few places to sit and a couple side
        tables.There are stairs going down to a hallway, a door to servant
        quarters and a door to Servant Bathrooms.");
    }
    ...
    {
        console.WriteLine("This is a simply decorated room. There are a handful of beds and a
        small dresser for each and a writing desk.There is a door to the
        servant hall.");
    }
    ...
    {
        console.WriteLine("This is a large bathroom with more than one toilet seperated by
partial stone wall dividers.There are also a pair of bathing pools
and a pair of sinks.There is a door to the servant hall.");
}
...
{
    console.WriteLine("This small room has nothing in it except a mirror that seems to be
    hovering in the air.You are able to walk around it and see your
